...
switch($_GET[act]){
  ...
  default:
    ...
    if ($_SESSION[leveluser]=='admin'){    
        echo "<h2>Manajemen Post Test</h2><hr>
        <div class='col-md-2'>
        ...
        echo "<br><br><table width=\"100%\" class=\"table table-striped table-bordered table-hover\" id=\"dataTables-example\">
            <thead>
          <tr><th>No</th><th>Judul</th><th>Tgl Buat</th><th>Pembuat</th><th>Waktu</th><th>Info</th><th>Terbit</th><th>Aksi</th></tr></thead>";
        
        $tampil_topik = mysqli_query($DBcon, "SELECT * FROM pelatihan ORDER BY id_pelatihan");
    ...
    while ($r=mysqli_fetch_array($tampil_topik)){
      ...
      $tgl_buat   = tgl_indo($r[tgl_buat]);
       echo "<tr><td>$no</td>
             <td>$r[judul]</td>
             <td>$tgl_buat</td>";
             $pelajaran2 = mysqli_query($DBcon, "SELECT * FROM trkatalog WHERE idtrkatalog = '$r[idtrkatalog]'");
             $p2=mysqli_fetch_array($pelajaran2);
             $pembuat = mysqli_query($DBcon, "SELECT * FROM pengajar WHERE id_pengajar = '$p2[id_pengajar]'");
             $cek_pembuat = mysqli_num_rows($pembuat);
             if (!empty($cek_pembuat)){
                 $data_pembuat = mysqli_fetch_array($pembuat);
                 echo "<td><a href=?module=admin&act=detailpengajar&id_pelatihan=$data_pembuat[id_pengajar] title='Detail pengajar'>$data_pembuat[EmployeeName]</a></td>";
             }else{                 
             ...
             <td><ul><li><a href='?module=quiz&act=edittopikquiz&id_pelatihan=$r[id_pelatihan]' title='Edit'><i class='fa fa-edit' alt='Edit'></i></a> | 
                 <a href=javascript:confirmdelete('$aksi?module=quiz&act=hapustopikquiz&id_pelatihan=$r[id_pelatihan]') title='Hapus'><i class='fa fa-trash' alt='Delete'></i></a></li>
                 <li><a href=?module=buatquiz&act=buatquiz&id_pelatihan=$r[id_pelatihan]>Buat Quiz</a></li>
                 <li><a href=?module=daftarquiz&act=daftarquiz&id_pelatihan=$r[id_pelatihan]>Daftar Quiz</a></li>
                 <li><a href=?module=quiz&act=daftarusersyangtelahmengerjakan&id_pelatihan=$r[id_pelatihan]>Daftar Peserta & Koreksi</a></li></ul></td></tr>";
      $no++;
    }
    echo "</table>";
        ...
        echo "<tr><td>$no</td>
         ...
         <td>$tgl_buat</td>
             ...
             <td><a href='?module=quiz&act=edittopikquiz&id_pelatihan=$r[id_pelatihan]' title='Edit'><i class='fa fa-edit' alt='Edit'> </i> | 
                ...
                <input type=button class='button small white' value='Peserta & koreksi' onclick=\"window.location.href='?module=quiz&act=daftarusersyangtelahmengerjakan&id_pelatihan=$r[id_pelatihan]';\"></input></td></tr>";
      $no++;
    }
    echo "</table>";      
    }
...
case 'pendaftaranlearning':
    if ($_SESSION[leveluser]=='users') {
        echo "<table width=\"100%\" class=\"table table-striped table-bordered table-hover\" id=\"dataTables-example\">
          ...
          $tampil_pelatihan = mysqli_query($DBcon, "SELECT * FROM pelatihan ORDER BY id_pelatihan DESC"); 
              $no=1;
        ...
        if (!empty($cek_mapel)){
            ...
            while ($t=mysqli_fetch_array($mapel)){                
                echo "<tr><td>$no</td>
                        ...
                        echo"<td><input type=button class='btn btn-primary' value='Lihat Pelatihan'
...
if (!empty($cek_materi)){
  echo"<br><b class='judul'>Daftar File Materi $data[nama] </b><br><p class='garisbawah'></p>";
  echo "<table width=\"100%\" class=\"table table-striped table-bordered table-hover\" id=\"dataTables-example\">
    <thead>
      <tr>
        <th>No</th>
  ...
  <tr>
    <td rowspan='5'>$no</td>";
  if (!empty($r[materi])){
  $pecah = explode(".", $r[materi]);
  $ekstensi = $pecah[1];
  if ($ekstensi == 'zip'){
      echo "
    <td style='vertical-align:middle;  color:blue;text-align:center; display: table-cell;'rowspan='5'><i class='fa fa-file-zip-o fa-5x'></td>";
  }
  elseif ($ekstensi == 'rar'){
      echo "<
    td style='vertical-align:middle;  color:blue;text-align:center; display: table-cell;'rowspan='5'><i class='fa fa-file-archive-o fa-5x'></td>";
  }
  elseif ($ekstensi == 'doc'){
      echo "
    <td style='vertical-align:middle;  color:blue;text-align:center; display: table-cell;'rowspan='5'><i class='fa fa-file-word-o fa-5x'></td>";
  }
  elseif ($ekstensi == 'pdf'){
      echo "
    <td style='vertical-align:middle;  color:blue;text-align:center; display: table-cell;'rowspan='5'><i class='fa fa-file-pdf-o fa-5x'></td>";
  }
  elseif ($ekstensi == 'ppt'){
      echo "
    <td style='vertical-align:middle;  color:blue;text-align:center; display: table-cell;'rowspan='5'><i class='fa fa-file-powerpoint-o fa-5x'></td>";
  }
  ...
  elseif ($ekstensi == 'docx'){
    ...
    <td style='vertical-align:middle;  color:blue;text-align:center; display: table-cell;'rowspan='5'><i class='fa fa-file-word-o fa-5x'></td>";
      ...
      echo "
    <td style='vertical-align:middle;  color:blue;text-align:center; display: table-cell;'rowspan='5'><i class='fa fa-warning fa-5x'></td>";
  }
  echo "
    <td>Nama File</td><td>$r[materi]</td>
    <tr><td>Ukuran</td>";
      if (!empty($r[materi])){
      $file = "files_pelatihan/$r[materi]";      
      echo "
      <td> ". fsize($file)."</td>
    </tr>";
      }else{
  ...
  echo"
  <tr>
    <td>Tanggal Pelatihan</td><td>$r[tanggal_pelaksanaan]</td>
  </tr>
  <tr>
    <td colspan=2><input type=button class=\"btn btn-info\" value='Download File' onclick=\"window.location.href='download_pelatihan.php?file=$r[materi]';\"><b> Diunduh $r[hits] kali</b>
    </td>
  </tr>";
        $no++;
        }
  ...
  <p class='garisbawah'></p><input type=button class=\"btn btn-primary\" value='Kembali'onclick=self.history.back()><input type='button' class='pull-right btn btn-primary' value='Daftar Learning' onclick=\"window.location.href='?module=quiz&act=daftarlearning&id_pelatihan=$r[id_pelatihan]&id_trkatalog=$r[id_trkatalog]';\"/>";
    }
    else{
...
case "daftartopik":
    if ($_SESSION[leveluser]=='users'){
        ...
        $topik = mysqli_query($DBcon, "SELECT * FROM pelatihan WHERE idtrkatalog = '$_GET[id_trkatalog]'");
        $cek_topik = mysqli_num_rows($topik);

        if (!empty($cek_topik)){
            echo"<br><b class='judul'>Daftar Post Test $data_mapel[nama]</b><br><p class='garisbawah'></p>
              <table width=\"100%\" class=\"table table-striped table-bordered table-hover\" id=\"dataTables-example\">
            <thead>
              <tr><th>No</th><th colspan='2'>Deskripsi Post Test</th></tr></thead>";
              $no=1;
              while($t=mysqli_fetch_array($topik)){
                  ...
                  $waktu = $t[waktu_pengerjaan] / 60;
                  echo"<tr><td rowspan=6>$no</td><td><b>Judul</b></td><td><b>$t[nama_pelatihan]</b></td></tr>
                       <tr><td><b>Tanggal Pelaksanaan</b></td><td><b>$tgl_posting</b></td></tr><tr><td><b>Tanggal Pelaksanaan</b></td><td><b>$tgl_berakhir</b></td></tr>";
                       if(!empty($cek_pengajar)){

                       $p = mysqli_fetch_array($pengajar);
                       echo"<tr><td><b>Pembuat</b></td><td><b>$p[EmployeeName]</b></td></tr>";
                       }else{
                           echo"<tr><td><b>Nama Trainer</b></td><td><b>$t[nama_trainer]</b></td></tr>";
                       }
                       echo"<tr><td><b>Waktu Pengerjaan</b></td><td><b>$waktu menit</b></td></tr>
                            <tr><td><b>Info Soal/Quiz</b></td><td><a>$t[materi]</a></td></tr>
                            <tr><td></td><td></td><td><input type=button class=\"btn btn-success\"  value='Kerjakan Post Test'
                       onclick=\"window.location.href='?module=quiz&act=infokerjakan&id_pelatihan=$t[id_pelatihan]';\"></td></tr>";
              $no++;
              }
              echo"</table>
...
case "daftarnilai":
    if ($_SESSION[leveluser]=='users'){
        $pendaftaran = mysqli_query($DBcon, "SELECT * FROM pendaftaran WHERE NIK = '$_SESSION[NIK]'");
        $data_pendaftaran = mysqli_fetch_array($pendaftaran);

        $trkatalog = mysqli_query($DBcon, "SELECT * FROM trkatalog WHERE idtrkatalog = '$_GET[id_trkatalog]'");
        $data_trkatalog = mysqli_fetch_array($trkatalog);
        $topik = mysqli_query($DBcon, "SELECT * FROM pelatihan WHERE idtrkatalog = '$_GET[id_trkatalog]' AND terbit='Y'");
        $cek_topik = mysqli_num_rows($topik);        
              ...
              $no=1;
               while($t=mysqli_fetch_array($topik)){
                  ...
                  echo"<tr><td rowspan=6>$no</td><td><b>Judul</b></td><td><b>$[nama_pelatihan]</b></td></tr>
                       ...
                       onclick=\"window.location.href='?module=quiz&act=nilaiusers&id_pelatihan=$t[id_pelatihan]';\"></td></tr>";
...
case "nilaiusers":
    if ($_SESSION[leveluser]=='users'){
        $quiz_pilganda = mysqli_query($DBcon, "SELECT * FROM quiz_pilganda WHERE id_pelatihan = '$_GET[id_pelatihan]'");
        $quiz_esay = mysqli_query($DBcon, "SELECT * FROM quiz_esay WHERE id_pelatihan = '$_GET[id_pelatihan]'");
        $c_pilganda = mysqli_num_rows($quiz_pilganda);
        $c_esay = mysqli_num_rows($quiz_esay);

        if (!empty($c_pilganda) AND !empty($c_esay)){
        $pilganda = mysqli_query($DBcon, "SELECT * FROM nilai WHERE id_pelatihan = '$_GET[id_pelatihan]' AND id_users = '$_SESSION[idusers]'");
        $cek_pilganda = mysqli_num_rows($pilganda);
        $esay = mysqli_query($DBcon, "SELECT * FROM nilai_soal_esay WHERE id_pelatihan = '$_GET[id_pelatihan]' AND id_users = '$_SESSION[idusers]'");
        $cek_esay = mysqli_num_rows($esay);

                if (!empty($cek_pilganda) AND !empty($cek_esay)){
                    echo"<br><b class='judul'>Nilai Anda</b><br>
                      <table width=\"100%\" class=\"table table-striped table-bordered table-hover\" id=\"dataTables-example\">
            <thead>
        ...
        $cek_esay = mysqli_num_rows($esay);
            ...
            <thead>
                ...
                elseif (empty($cek_esay)) {
                    $kerjakan = mysqli_query($DBcon, "SELECT * FROM users_sudah_mengerjakan WHERE id_pelatihan='$_GET[id_pelatihan]' AND id_users = '$_SESSION[idusers]'");
...
case "infokerjakan":
    if ($_SESSION[leveluser]=='users'){
        ...
        echo"
        <input type=button class=\"btn btn-danger\" value='Kembali' onclick=self.history.back()>
        <input type=submit class='btn btn-success' value='Mulai Mengerjakan' onclick='window.location.reload()'>";
        }
        elseif ($data[hits] >= 1){
...
case "buatquizpilganda":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo"<div class=\"panel-body\">
                  <div class=\"row\">
                  <div class=\"col-lg-6\">
             <legend>Buat Pertanyaan Pilihan Ganda</legend>
...
case "daftarquizpilganda":
    ...
    echo "</table>";
    echo "<br><input type=button class=\"btn btn-primary\" value='Tambah Quiz Pilihan ganda' onclick=\"window.location.href='?module=quiz&act=buatquizpilganda&id_pelatihan=$jq[id_pelatihan]';\">
              <input type=button class=\"btn btn-danger\" value=Kembali onclick=\"window.location.href='?module=acara';\">";
    }else{
        ...
        echo "<div class='information msg'><b>Daftar Soal Post Test Pilihan Ganda</b></div>
              <div class='panel-body'>
          <legend>Info Post Test</legend>
            <div class='table-responsive'>
              <table class='table table-hover'>
        ...
        echo "<div class='col-md-4'><input type=button class=\"btn btn-primary\" value='Tambah Quiz Pilihan ganda' onclick=\"window.location.href='?module=quiz&act=buatquizpilganda&id_pelatihan=$jq[id_pelatihan]';\">
              <input type=button class=\"btn btn-danger\" value=Kembali onclick=\"window.location.href='?module=acara';\"></div>";
    ...
    while ($q=mysqli_fetch_array($quiz)){
       echo "<tr><td rowspan=8><b>$no.</b></td>
             ...
             <tr><td>Pilihan D</td><td> $q[pil_d]</td></tr>
             <tr><td>Kunci Jawaban</td><td> $q[kunci]</td></tr>
             <tr><td>Aksi</td><td> <a href='?module=quiz&act=editquizpilganda&id_pelatihan=$q[id_quiz]&id_pelatihan=$q[id_pelatihan]' title='Edit'><i class='fa fa-edit' alt='Edit'> </i></a> |
                 <a href=javascript:confirmdelete('$aksi?module=quiz&act=hapusquizpilganda&id_pelatihan=$q[id_quiz]&id_pelatihan=$q[id_pelatihan]') title='Hapus'><i class='fa fa-trash' alt='Delete'> </i></a></td></tr>
             ";
      $no++;
    }
    echo "</table>";
