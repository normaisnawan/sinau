...
$aksi_users = "4d177in/modul/mod_users/aksi_users.php";
switch($_GET[act]){
  // Tampil User
  default:
    ...
    elseif ($_SESSION[leveluser]=='pengajar') {
      ...
      echo "<ol>
              <li>User tidak bisa di hapus, tapi bisa di non aktifkan.</li>
              <li>Jika <i>gagal</i> menambahkan <b>user</b> silakan cek format foto atau ukuran foto anda.
            </ol><br>";
      echo "<input class='btn btn-success' type=button value='Tambah User' onclick=\"window.location.href='?module=users&act=tambahuser';\"><hr>";
    ...
    while ($r=mysqli_fetch_array($tampil_users)){
       echo "<tr>
             ...
             <td><a href='?module=users&act=edituser&id=$r[id_users]' title='Edit'><img src='images/icons/edit.png' alt='Edit' /></a> |
    ...
    if ($_SESSION[leveluser]=='users'){
      ...
      echo "
       <table width=\"100%\" class=\"table table-striped table-bordered table-hover\" id=\"dataTables-example\">
          ...
          <tr>
            <td colspan='3'>
              <input type=button class=\"btn btn-primary pull-right\" value='Edit Profil' onclick=\"window.location.href='?module=users&act=edituser&id=$users[id_users]';\">
            </td>
          </tr>
        </table>";
    }
